...
interface CompareFiltersProps {
  suppliers: Supplier[];
  onFilteredSuppliersChange: (filtered: Supplier[]) => void;
  className?: string;
}

export function CompareFilters({ suppliers, onFilteredSuppliersChange, className = "" }: CompareFiltersProps) {
        ...
        <CollapsibleTrigger asChild>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Compare Filters</span>
